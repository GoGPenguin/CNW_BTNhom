<%@ page import="Model.BEAN.User" %> <%@ page import="java.util.ArrayList" %>
<%@ page import="Model.BEAN.Admin" %><%-- Created by IntelliJ IDEA. User: Nho
Date: 01/12/2023 Time: 5:07 PM To change this template use File | Settings |
File Templates. --%> <%@ page contentType="text/html;charset=UTF-8"
language="java" %>

<html>
  <% session = request.getSession(false); if (session != null &&
  session.getAttribute("admin") != null) { Admin admin = (Admin)
          ...
          <div class="d-flex align-items-start">
            ...
            >
              ...
              <button
                ...
                aria-selected="false"
                onclick="loadManagerProductPage()"
              >
                <i class="fa-brands fa-slack"></i>Manage Product
              </button>
              <button
                class="nav-link"
                data-bs-toggle="pill"
                ...
                aria-controls="v-pills-messages"
                aria-selected="false"
                onclick="loadManagerCategoryPage()"
              >
              ...
              <button
                ...
                aria-controls="v-pills-messages"
                aria-selected="false"
                onclick="loadManagerOrderPage()"
              >
                <i class="fa-solid fa-cart-shopping"></i>Manage Order
              </button>
            </div>
          </div>
        </div>
