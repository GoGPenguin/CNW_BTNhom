...
<%--            <button type="button" class="btn btn-primary" style="width:80%;" onclick="loadManagerOrderPage()">Manage Order</button>--%>
    <div class="d-flex align-items-start">
        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical"  >
            ...
            <button class="nav-link"  data-bs-toggle="pill"  type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="loadManagerProductPage()"><i class="fa-brands fa-slack"></i>Manage Product</button>
            <button class="nav-link"  data-bs-toggle="pill"  type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false" onclick="loadManagerCategoryPage()"><i class="fa-solid fa-list"></i>Manage Categogy</button>
